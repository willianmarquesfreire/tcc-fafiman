...
Pedro Zambarda. \emph 'Internet das Coisas': entenda o conceito e o que muda com a tecnologia. [Online] Disponível: http://www.techtudo.com.br/noticias/noticia/2014/08/internet-das-coisas-entenda-o-conceito-e-o-que-muda-com-tecnologia.html 
...
Cleuton Sampaio. (2017). \emph Micro serviços: O que são e para que servem. [Online] Disponível: http://www.obomprogramador.com/2015/03/micro-servicos-o-que-sao-e-para-que.html. [Acesso: 28-Fev-2017] 
...
Adriano Almeida. (2016). \emph Arquitetura de microserviços ou monolítica. [Online] Disponível: http://blog.caelum.com.br/arquitetura-de-microservicos-ou-monolitica. [Acesso: 22-Mar-2017]

\bibitem{CristianoDiedrich}
Cristiano Diedrich. (2016). \emph O que é Docker. [Online] Disponível: http://www.mundodocker.com.br/o-que-e-docker. [Acesso: 01-Dez-2016]

\bibitem{JanStenberg}
Jan Stenberg. (2016). \emph O estado da arte em micro serviços. [Online] Disponível: https://www.infoq.com/br/news/2015/04/microservices-current-state. [Acesso: 08-Fev-2017]

\bibitem{RicardoPeloi}
Ricardo Peloi. (2016). \emph Como implantar uma verdadeira Arquitetura de Microserviços na sua empresa. [Online] Disponível: http://sensedia.com/blog/soa/implantar-arquitetura-de-microservicos. [Acesso: 08-Mar-2017]
...
\bibitem{ChrisRichardson}
Chris Richardson. (2016). \emph Whois using microservices. [Online] Disponível: http://microservices.io/articles/whoisusingmicroservices.html. [Acesso: 20-Mai-2017]

\bibitem{tiagokhouri}
Tiago Khouri. (2017). \emph IoT será mera tempestade se comparada ao tsunami da Realidade Virtual. [Online] Disponível: http://computerworld.com.br/iot-sera-mera-tempestade-se-comparada-ao-tsunami-da-realidade-virtual. [Acesso: 10-Fev-2017]

\bibitem{idc2017}
IDC. (2016). \emph Connecting the IotT: The road to success. [Online] Disponível: http://www.idc.com/infographics/IoT. [Acesso: 15-Fev-2017]

\bibitem{martinfowleretal}
Martin Fowler et al. (2016). \emph Microservices. [Online] Disponível: https://www.martinfowler.com/articles/microservices.html. [Acesso: 20-Mai-2017]

\bibitem{manutayal2016}
Manu Tayal. (2016). \emph IoT and Microservices Architecture. [Online] Disponível: http://www.happiestminds.com/blogs/iot-and-microservices-architecture. [Acesso: 25-Abr-2017]

\bibitem{rossaltman2017}
Ross Altman. (2017). \emph SOA and Application Architecture Key Initiative Overview. [Online] Disponível: https://www.gartner.com/doc/2513915/soa-application-architecture-key-initiative. [Acesso: 28-Fev-2017]

\bibitem{rossaltmankirkknoernschild2016}
Ross Altman, Kirk Knoernschild. (2016). \emph SOA and Application Architecture Key Initiative Overview. [Online] Disponível: https://www.gartner.com/doc/2513915/soa-application-architecture-key-initiative. [Acesso: 10-Mai-2017]

\bibitem{kemelzaidan2016}
Kemel Zaidan. (2016). \emph Gerenciamento e Escalabilidade de Container Docker no Jelastic. [Online] Disponível: http://blog.locaweb.com.br/geral/gerenciamento-e-escalabilidade-de-container-docker-no-jelastic-2. [Acesso: 15-Mar-2017]

\bibitem{netflix2016Ribbon}
Netflix. (2016). \emph Ribbon. [Online] Disponível: https://github.com/Netflix/ribbon/wiki. [Acesso: 06-Mai-2017]

\bibitem{netflix2016Zuul}
Netflix. (2016). \emph Zuul. [Online] Disponível: https://github.com/Netflix/zuul/wiki. [Acesso: 02-Mai-2017]

\bibitem{martinfowler2017CircuitBreaker}
Martin Fowler. (2017). \emph CircuitBreaker. [Online] Disponível: https://martinfowler.com/bliki/CircuitBreaker.html. [Acesso: 02-Mar-2017]

\bibitem{danilosato2017}
Danilo Sato. (2017). \emph CanaryRelease. [Online] Disponível: https://martinfowler.com/bliki/CanaryRelease.html. [Acesso: 10-Abr-2017]

\bibitem{netflix2017SpringCloud}
Netflix. (2017). \emph Spring Cloud Netflix. [Online] Disponível: http://cloud.spring.io/spring-cloud-netflix/spring-cloud-netflix.html. [Acesso: 18-Dez-2016]

\bibitem{reactivex2017}
ReactiveX. (2017). \emph Observable. [Online] Disponível: http://reactivex.io/documentation/observable.html. [Acesso: 25-Nov-2016]

\bibitem{nodemcu2017}
NodeMCU. (2017). \emph NodeMCU 2.0.0. [Online] Disponível: https://github.com/nodemcu/nodemcu-firmware. [Acesso: 10-Dez-2017]

\bibitem{elua2017}
ELua. (2017). \emph What is eLua. [Online] Disponível: http://www.eluaproject.net/overview. [Acesso: 19-Nov-2017]

\bibitem{systems}
Systems. (2017). \emph Expressif Systems. [Online] Disponível: http://espressif.com/company/contact/pre-sale-questions. [Acesso: 11-Nov-2016]

\bibitem{williamstewart2017}
William Stewart. (2017). \emph C Programming Language History. [Online] Disponível: http://www.livinginternet.com/i/iw\_unix\_c.htm. [Acesso: 15-Mai-2017]

\bibitem{lua2017Authors}
Lua. (2017). \emph Authors. [Online] Disponível: http://www.lua.org/authors.html. [Acesso: 5-Fev-2017]
...
Joris Evers. (2017). \emph Forrester CEO: Web services next IT storm. [Online] Disponível: http://www.infoworld.com/article/2681101/operating-systems/forrester-ceo--web-services-next-it-storm\.html. [Acesso: 28-Mai-2017]

\bibitem{roythomasfielding2017}
Roy Thomas Fielding. (2017). \emph Representational State Transfer (REST. [Online] Disponível: http://www.ics.uci.edu/~fielding/pubs/dissertation/rest\_arch\_style\.htm. [Acesso: 29-Mai-2017]

\bibitem{idgns2017}
IDGNS. (2017). \emph Optar por micro-serviços em vez de software monolítico. [Online] Disponível: https://www.computerworld.com.pt/2016/12/05/optar-por-micro-servicos-em-vez-de-software-monolitico. [Acesso: 23-Fev-2017]
